@echo off
REM Git Aliases Setup Script (Windows)
REM This script configures git aliases for branch creation conventions

echo Setting up git aliases for branch creation...

REM Feature branch alias
echo Adding 'feature' alias...
git config --add alias.feature "!f(){ git checkout -b feature/$1 dev; }; f"

REM AI experiments branch alias
